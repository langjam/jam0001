...
extern int hashmap_create(const unsigned initial_size,
...
extern int hashmap_put(struct hashmap_s *const hashmap, const char *const key,
...
extern void *hashmap_get(const struct hashmap_s *const hashmap,
...
/// @param len The length of the string key.
/// @return On success 0 is returned.
extern int hashmap_remove(struct hashmap_s *const hashmap,
                          const char *const key,
                          const unsigned len) HASHMAP_USED;
...
extern int hashmap_iterate(const struct hashmap_s *const hashmap,
...
extern int hashmap_iterate_pairs(struct hashmap_s *const hashmap,
                                 int (*f)(void *const,
...
extern void hashmap_destroy(struct hashmap_s *const hashmap) HASHMAP_USED;

extern unsigned hashmap_crc32_helper(const char *const s,
                                     const unsigned len) HASHMAP_USED;
extern unsigned hashmap_hash_helper_int_helper(const struct hashmap_s *const m,
                                               const char *const keystring,
                                               const unsigned len) HASHMAP_USED;
extern int hashmap_match_helper(const struct hashmap_element_s *const element,
                                const char *const key,
                                const unsigned len) HASHMAP_USED;
extern int hashmap_hash_helper(const struct hashmap_s *const m,
...
extern int hashmap_rehash_helper(struct hashmap_s *const m) HASHMAP_USED;
